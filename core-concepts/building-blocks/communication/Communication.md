...
*⬅️⬅️ Previous Group: [Speed](../speed/Speed.md) &nbsp;| &nbsp; ➡️ Deep Dive this group starting with: [Distributed Messaging Queue](distributed-messaging-queue.md)  | &nbsp; ➡️➡️ Next Group: [Processing](../processing/Processing.md)*